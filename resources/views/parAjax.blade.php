...
<button class="btn btn-primary"  onChange="combo(this, 'theinput')" onMouseOut="comboInit(this, 'theinput')" >
 <select style="background-color: white" style="text-decoration-color: white ">
  <option>CPD</option>
  <option>IDD</option>
  <option>FAD</option>
</select>
